...
__DEFINE__(1651306312099, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1651306312100,"./event-store":1651306312101}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1651306312100, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1651306312101, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1651306312100,"./utils":1651306312102}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1651306312102, function(require, module, exports) {
...
return __REQUIRE__(1651306312099);
})()
